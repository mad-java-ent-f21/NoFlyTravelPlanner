...
INSERT INTO `destinations` VALUES (54880,'Park','Wisconsin',137,14,NULL,15,'Scenic','Camp'),(80809,'Mountain','Colorado',100,30,NULL,29,'Scenic','Multiple');
...
INSERT INTO `users` VALUES (1,'Joe','Coyne','jcoyne','enyoC','CoolKid'),(2,'Tina','Miller','tmiller','relliM','fishhateme'),(3,'Jayme','Stolt','jystolt','tlotS','whystayhome'),(4,'Jim','Stolt','jstolt','tlotS','phisherpun'),(5,'Laura','Johnson','ljohnson','nosnhoH','Treehugger'),(6,'Marcy','Smith','msmith','htimS','climbOn'),(7,'Kari','Metford','kmetford','drofteM','Huntress'),(8,'Phillip','Walters','pwalters','sretlaW','Snowman'),(9,'John','Wheeler','jwheeler','releehW','Wheelee'),(10,'Jeanne','Wood','jwood','dooW','lostNotFound'),(11,'Tom','Cotten','tcotten','nettoC','offscreen'),(12,'Susan','Jones','sjones','senoJ','add_venture'),(13,'Brian','Miles','bmiles','seliM','WhyNot'),(14,'Mike','Jackson','mjackson','noskcaK','Eaglemann'),(15,'Sara','Cooper','scooper','repooC','skinnyski'),(16,'Lisa','Jordan','ljorden','nadroJ','Creek'),(17,'Jason','Shardt','jshardt','tdrahS','prairewalker'),(18,'Amder','Brenner','abrenner','rennerB','RVRoadee'),(19,'Fred','Flintstone','fflintstone','badpassword','Freddy');
...
-- Dump completed on 2021-10-31 19:25:46
